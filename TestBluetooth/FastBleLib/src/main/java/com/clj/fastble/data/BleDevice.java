...
public class BleDevice implements Parcelable {
    ...
    public String toString() {
        ...
        sb.append("mDevice=").append(mDevice);
        sb.append(", mScanRecord=").append(Arrays.toString(mScanRecord));
        sb.append(", mRssi=").append(mRssi);
        sb.append(", mTimestampNanos=").append(mTimestampNanos);
        sb.append('}');
        return sb.toString();
    }
}
