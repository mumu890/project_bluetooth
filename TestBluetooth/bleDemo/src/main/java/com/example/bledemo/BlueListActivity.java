...
public class BlueListActivity extends Activity implements OnClickListener, BluetoothCallBack, UncaughtExceptionHandler {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.activity_blulist);
	...
	public void initView() {
		...
		if(bluetoothUtil.mBluetoothAdapter.enable()) {
